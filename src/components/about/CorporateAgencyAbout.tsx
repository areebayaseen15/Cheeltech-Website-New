...
const CorporateAgencyAbout = () => {
    return (
        <div className="crp-about-area pt-120 pb-100 z-index-1">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4">
                            <div className="crp-about-left">
                                <span className="tp-section-subtitle-teko mb-120 tp_fade_anim" data-delay=".3">Your<br /> <i>Tech</i> Partner</span>
