import aboutShape2 from '../../../public/assets/img/images/abou-shape-2.png';
import aboutImg from '../../../public/assets/img/Cheeltech-images/about-stories/img1.jpg';
import aboutImg2 from '../../../public/assets/img/Cheeltech-images/about-stories/img3.jpg';
import aboutImg3 from '../../../public/assets/img/Cheeltech-images/about-stories/img-2.jpg';
...
const ITSolutionAbout = () => {
    return (
        <div className="it-about-area it-about-ptb pt-10 pb-40 p-relative">
                    ...
                    <div className="col-xl-4">
                        <div className="it-about-title-box z-index-2">
                            ...
                            <div className="tp_text_anim">
                                <p>
                                    {`That’s why we’re`}  dedicated to providing innovative, reliable, and responsive <b>web solutions</b> that keep your <b>digital platforms</b> running smoothly and securely.
                                </p>
                            </div>
                            <div className="tp_fade_anim" data-fade-from="top" data-ease="bounce">
                                <Link className="tp-btn-black-radius btn-blue-bg  d-inline-flex align-items-center justify-content-between mr-15" href="/About">
                                    <span>
