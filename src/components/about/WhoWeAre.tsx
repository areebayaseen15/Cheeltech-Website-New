...
import aboutImgOne from "../../../public/content1.jpg.jpeg"
                        ...
                        <div className="col-xl-9">
                            <div className="tp-about-wrap">
                                <div className="tp-about-text tp_fade_anim">
                                    <p>
                                       An independent web development agency established in 2021 in Karachi, Pakistan. We are technical specialists who build robust digital solutions through collaboration and proven industry experience.
                                    </p>
                                </div>
                                <div className="row">
                                        ...
                                        <div className="tp-about-funcact-wrap">
                                            <div className="tp-about-avater-info">
                                                ...
                                                <div className="tp_text_anim">
                                                    <p>Driven by a passion for innovation, we specialize in <br/> delivering top-quality, robust development solutions.</p>
                                                </div>
                                            </div>
                                            {/* counter area */}
                                            <HomeMainCounter />
